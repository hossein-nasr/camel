...
Soroush messenger is an Iranian instant messaging application, developed by Soroush Media Technology Development.
The messenger has Android and iOS versions for phones, and also Windows, MacOS and Linux versions for computers.
